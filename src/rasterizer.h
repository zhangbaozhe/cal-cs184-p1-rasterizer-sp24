...
public:
  ...
  // Rasterize a line
  virtual void rasterize_line(float x0, float y0, float x1, float y1,
                              Color color) = 0;
  ...
  // P1 = (x1, y1)
  // P2 = (x2, y2)
  virtual void rasterize_triangle(float x0, float y0, float x1, float y1,
                                  float x2, float y2, Color color) = 0;

  virtual void rasterize_interpolated_color_triangle(float x0, float y0,
                                                     Color c0, float x1,
                                                     float y1, Color c1,
                                                     float x2, float y2,
                                                     Color c2) = 0;

  virtual void rasterize_textured_triangle(float x0, float y0, float u0,
...
public:
  RasterizerImp(PixelSampleMethod psm, LevelSampleMethod lsm, size_t width,
